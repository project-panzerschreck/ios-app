...
The shared arm64 framework build also assumes your local `../llama.cpp-rpc` checkout includes the iOS 12 compatibility fixes used by this workspace, specifically in:
